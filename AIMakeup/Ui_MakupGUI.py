...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self):
        ...
        self.window.setWindowTitle(_translate("MainWindow", "Beautify"))
        self.bt_whitening.setText(_translate("MainWindow", "Whitening"))
        self.bt_smooth.setText(_translate("MainWindow", "Smooth"))
        self.bt_sharpen.setText(_translate("MainWindow", "Bright eyes"))
        self.bt_brightening.setText(_translate("MainWindow", "Red lips"))
        self.bt_open.setText(_translate("MainWindow", "Open file"))
        ...
        self.bt_view_compare.setText(_translate("MainWindow", "Compare"))
        self.bt_save.setText(_translate("MainWindow", "Save"))
        self.bt_save_compare.setText(_translate("MainWindow", "Save Compare"))
